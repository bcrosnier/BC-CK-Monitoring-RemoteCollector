...
namespace CodeCake
{
    ...
    public partial class Build
    {
        ...
        public class NuGetArtifactType : ArtifactType
        {
            ...
            {
                if (GlobalInfo.BuildInfo.Version.PackageQuality >= CSemVer.PackageQuality.ReleaseCandidate)
                    yield return new RemoteFeed(this, "nuget.org", "https://api.nuget.org/v3/index.json",
